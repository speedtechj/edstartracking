  ...
  <nav class="container relative max-w-full shadow-md" >
    ...
    <div class="flex justify-between items-center bg-white w-full p-3">
        ...
        <div class="text-black hidden space-x-6 md:flex ml-80">
          <a href="https://forexcargodeals.com/edmonton/book-online" class="hover:border-b-2 hover:border-[#26577C] duration-75"> Send Goods</a>
          <a href="https://calgarytracking.forexcargodeals.com" class=" hover:border-b-2 hover:border-[#26577C] duration-75">Track Calgary</a>
